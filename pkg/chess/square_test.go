...
func TestNewSquareEnPassantFromFEN(t *testing.T) {
	...
	tests := []struct {
		...
		{"h6", Ptr(SquareH6), ""},
		{"-", nil, ""},
		{"a1", nil, "invalid En Passant rank 0"},
		{"b2", nil, "invalid En Passant rank 1"},
		{"d4", nil, "invalid En Passant rank 3"},
		{"e5", nil, "invalid En Passant rank 4"},
		{"g7", nil, "invalid En Passant rank 6"},
		{"h8", nil, "invalid En Passant rank 7"},
